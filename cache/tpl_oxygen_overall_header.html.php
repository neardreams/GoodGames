...
<head>
<?php $this->_tpl_include('oxygen_config.html'); ?>
...
<a id="top" name="top" accesskey="t"></a>
	<div id="header">
		<?php if ($this->_tpldata['DEFINE']['.']['TEXT_LOGO'] == ('no')) {  ?>
		...
		<h2><a href="<?php echo (isset($this->_rootref['U_INDEX'])) ? $this->_rootref['U_INDEX'] : ''; ?>" title="<?php echo ((isset($this->_rootref['L_INDEX'])) ? $this->_rootref['L_INDEX'] : ((isset($user->lang['INDEX'])) ? $user->lang['INDEX'] : '{ INDEX }')); ?>" class="logo_text"><?php if ($this->_tpldata['DEFINE']['.']['FA'] == ('yes')) {  ?><i class="fa <?php echo (isset($this->_tpldata['DEFINE']['.']['TEXT_LOGO_ICON'])) ? $this->_tpldata['DEFINE']['.']['TEXT_LOGO_ICON'] : ''; ?>"></i><?php } ?> <?php echo (isset($this->_rootref['SITENAME'])) ? $this->_rootref['SITENAME'] : ''; ?></a></h2>
		<?php } if ($this->_rootref['S_DISPLAY_SEARCH'] && ! $this->_rootref['S_IN_SEARCH']) {  if ($this->_tpldata['DEFINE']['.']['SEARCH_HEAD'] == ('yes')) {  ?>

		<div class="search_box">
			<form action="<?php echo (isset($this->_rootref['U_SEARCH'])) ? $this->_rootref['U_SEARCH'] : ''; ?>" method="get" id="search">
				<fieldset>
					<input name="keywords" type="text" maxlength="128" title="<?php echo ((isset($this->_rootref['L_SEARCH_KEYWORDS'])) ? $this->_rootref['L_SEARCH_KEYWORDS'] : ((isset($user->lang['SEARCH_KEYWORDS'])) ? $user->lang['SEARCH_KEYWORDS'] : '{ SEARCH_KEYWORDS }')); ?>" class="" placeholder="<?php echo ((isset($this->_rootref['L_SEARCH_KEYWORDS'])) ? $this->_rootref['L_SEARCH_KEYWORDS'] : ((isset($user->lang['SEARCH_KEYWORDS'])) ? $user->lang['SEARCH_KEYWORDS'] : '{ SEARCH_KEYWORDS }')); ?>" />
				</fieldset>
			</form>
		</div>
		<?php } } ?>
	...
	<div class="nav">
		<ul class="bar">
			<li<?php if ($this->_rootref['SCRIPT_NAME'] == ('index')) {  ?> class="active"<?php } ?>><a href="<?php echo (isset($this->_rootref['U_INDEX'])) ? $this->_rootref['U_INDEX'] : ''; ?>"><?php if ($this->_tpldata['DEFINE']['.']['FA'] == ('yes')) {  ?><i class="fa fa-home"></i><?php } ?> <?php echo ((isset($this->_rootref['L_INDEX'])) ? $this->_rootref['L_INDEX'] : ((isset($user->lang['INDEX'])) ? $user->lang['INDEX'] : '{ INDEX }')); ?></a></li>
			<li<?php if ($this->_tpldata['DEFINE']['.']['CURRENT_PAGE'] == ('members')) {  ?> class="active"<?php } ?>><a href="<?php echo (isset($this->_rootref['U_MEMBERLIST'])) ? $this->_rootref['U_MEMBERLIST'] : ''; ?>"><?php if ($this->_tpldata['DEFINE']['.']['FA'] == ('yes')) {  ?><i class="fa fa-group"></i><?php } ?> <?php echo ((isset($this->_rootref['L_MEMBERLIST'])) ? $this->_rootref['L_MEMBERLIST'] : ((isset($user->lang['MEMBERLIST'])) ? $user->lang['MEMBERLIST'] : '{ MEMBERLIST }')); ?></a></li>
			<li<?php if ($this->_tpldata['DEFINE']['.']['CURRENT_PAGE'] == ('faq')) {  ?> class="active"<?php } ?>><a href="<?php echo (isset($this->_rootref['U_FAQ'])) ? $this->_rootref['U_FAQ'] : ''; ?>"><?php if ($this->_tpldata['DEFINE']['.']['FA'] == ('yes')) {  ?><i class="fa fa-info"></i><?php } ?> <?php echo ((isset($this->_rootref['L_FAQ'])) ? $this->_rootref['L_FAQ'] : ((isset($user->lang['FAQ'])) ? $user->lang['FAQ'] : '{ FAQ }')); ?></a></li>
			<?php if ($this->_tpldata['DEFINE']['.']['SEARCH_HEAD'] == ('no')) {  ?><li<?php if ($this->_tpldata['DEFINE']['.']['CURRENT_PAGE'] == ('search')) {  ?> class="active"<?php } ?>><a href="<?php echo (isset($this->_rootref['U_SEARCH'])) ? $this->_rootref['U_SEARCH'] : ''; ?>"><?php if ($this->_tpldata['DEFINE']['.']['FA'] == ('yes')) {  ?><i class="fa fa-search"></i><?php } ?> <?php echo ((isset($this->_rootref['L_SEARCH'])) ? $this->_rootref['L_SEARCH'] : ((isset($user->lang['SEARCH'])) ? $user->lang['SEARCH'] : '{ SEARCH }')); ?></a></li><?php } ?>

			
		</ul>
		<ul class="left">
				<?php if (! $this->_rootref['S_IS_BOT']) {  if (! $this->_rootref['S_IS_BOT'] && $this->_rootref['S_USER_LOGGED_IN']) {  if ($this->_rootref['S_DISPLAY_SEARCH']) {  ?>

					<li<?php if ($this->_tpldata['DEFINE']['.']['CURRENT_PAGE'] == ('search')) {  ?> class="active"<?php } ?>><a href="<?php echo (isset($this->_rootref['U_SEARCH_SELF'])) ? $this->_rootref['U_SEARCH_SELF'] : ''; ?>"><?php if ($this->_tpldata['DEFINE']['.']['FA'] == ('yes')) {  ?><i class="fa fa-comments"></i><?php } ?> <?php echo ((isset($this->_rootref['L_SEARCH_SELF'])) ? $this->_rootref['L_SEARCH_SELF'] : ((isset($user->lang['SEARCH_SELF'])) ? $user->lang['SEARCH_SELF'] : '{ SEARCH_SELF }')); ?></a></li>
					<?php } } if (! $this->_rootref['S_USER_LOGGED_IN'] && $this->_rootref['S_REGISTER_ENABLED'] && ! ( $this->_rootref['S_SHOW_COPPA'] || $this->_rootref['S_REGISTRATION'] )) {  ?><li><a href="<?php echo (isset($this->_rootref['U_REGISTER'])) ? $this->_rootref['U_REGISTER'] : ''; ?>"><?php if ($this->_tpldata['DEFINE']['.']['FA'] == ('yes')) {  ?><i class="fa fa-plus"></i><?php } ?> <?php echo ((isset($this->_rootref['L_REGISTER'])) ? $this->_rootref['L_REGISTER'] : ((isset($user->lang['REGISTER'])) ? $user->lang['REGISTER'] : '{ REGISTER }')); ?></a></li><?php } ?>

					<li><a href="<?php echo (isset($this->_rootref['U_LOGIN_LOGOUT'])) ? $this->_rootref['U_LOGIN_LOGOUT'] : ''; ?>" title="<?php echo ((isset($this->_rootref['L_LOGIN_LOGOUT'])) ? $this->_rootref['L_LOGIN_LOGOUT'] : ((isset($user->lang['LOGIN_LOGOUT'])) ? $user->lang['LOGIN_LOGOUT'] : '{ LOGIN_LOGOUT }')); ?>" accesskey="x"><?php if ($this->_tpldata['DEFINE']['.']['FA'] == ('yes')) {  ?><i class="fa fa-sign-in"></i><?php } ?> <?php echo ((isset($this->_rootref['L_LOGIN_LOGOUT'])) ? $this->_rootref['L_LOGIN_LOGOUT'] : ((isset($user->lang['LOGIN_LOGOUT'])) ? $user->lang['LOGIN_LOGOUT'] : '{ LOGIN_LOGOUT }')); ?></a></li>
				<?php } ?>
	...
	<div id="page-header">
		<div class="breadcrumbs">
			<ul class="crumb">
				...
				<?php $_navlinks_count = (isset($this->_tpldata['navlinks'])) ? sizeof($this->_tpldata['navlinks']) : 0;if ($_navlinks_count) {for ($_navlinks_i = 0; $_navlinks_i < $_navlinks_count; ++$_navlinks_i){$_navlinks_val = &$this->_tpldata['navlinks'][$_navlinks_i]; ?><li> <strong>&#8249;</strong> <a href="<?php echo $_navlinks_val['U_VIEW_FORUM']; ?>"><?php echo $_navlinks_val['FORUM_NAME']; ?></a></li><?php }} ?>
			...
			<ul class="bread">
				...
				<?php if ($this->_rootref['S_DISPLAY_PM']) {  ?><li class="icon-msg"><a href="<?php echo (isset($this->_rootref['U_PRIVATEMSGS'])) ? $this->_rootref['U_PRIVATEMSGS'] : ''; ?>"><?php echo (isset($this->_rootref['PRIVATE_MESSAGE_INFO'])) ? $this->_rootref['PRIVATE_MESSAGE_INFO'] : ''; ?></a></li><?php } ?>
