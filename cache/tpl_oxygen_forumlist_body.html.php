			...
			<ul class="topiclist">
				<li class="header">
					<dl class="icon">
						...
						<dd class="lastpost"><dfn><?php echo ((isset($this->_rootref['L_LAST_POST'])) ? $this->_rootref['L_LAST_POST'] : ((isset($user->lang['LAST_POST'])) ? $user->lang['LAST_POST'] : '{ LAST_POST }')); ?></dfn></dd>
					</dl>
				</li>
			</ul>
			</div>
...
<?php } } else { $this->_tpl_include('forumlist_grid.html'); } ?>